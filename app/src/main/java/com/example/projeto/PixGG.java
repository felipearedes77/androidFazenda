...
public class PixGG extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pix_gg);
            ...
            public void onResponse(Call<Produtos> call, Response<Produtos> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if (novoEstoque < 0) {
                        ...
                        Toast.makeText(PixGG.this, "Estoque insuficiente!", Toast.LENGTH_SHORT).show();
                    } else {
                        ...
                        updateCall.enqueue(new Callback<Produtos>() {
                            ...
                            public void onResponse(Call<Produtos> call, Response<Produtos> response) {
                                if (response.isSuccessful()) {
                                    Toast.makeText(PixGG.this, "Pagamento confirmado e estoque atualizado!", Toast.LENGTH_SHORT).show();
                                    Intent intent = new Intent(PixGG.this, obrigado.class);
                                    startActivity(intent);
                                    finish();
                                } else {
                                    Toast.makeText(PixGG.this, "Erro ao atualizar estoque!", Toast.LENGTH_SHORT).show();
                            ...
                            public void onFailure(Call<Produtos> call, Throwable t) {
                                Toast.makeText(PixGG.this, "Falha na comunicação com o servidor!", Toast.LENGTH_SHORT).show();
                                Log.e("Pix", "Falha na comunicação com o servidor!" + response.message());
                            }
                        });
                    }
                } else {
                    Toast.makeText(PixGG.this, "Produto não encontrado!", Toast.LENGTH_SHORT).show();
                }
            }
